...
if($_SERVER['HTTP_HOST'] !== 'environment.uw.dev' && $_SERVER['HTTP_HOST'] !== 'environment.uw.local' && $_SERVER['HTTP_HOST'] !== 'beta.environment.uw.edu' && $_SERVER['HTTP_HOST'] !== 'uwenvironment.local') {
